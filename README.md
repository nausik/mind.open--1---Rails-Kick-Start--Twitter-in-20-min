...
Для этого нужно ввести команду rails g devise:install
...
Теперь раскомментируем строку config.authentication_keys и изменим :email на :username
...
Теперь нужно просто дописать к attr_accessible :username
